      ...
      >
        ...
        >
          <p className="font-urbanist lg:text-4xl md:text-3xl  font-normal text-white text-center left-1/2 -translate-x-1/2">
            ...
            yo{" "}
            <span className="text-[#e2c898] font-amatic font-bold lg:text-[2.7rem] md:text-4xl text-xl lg:leading-10 ">
              passionate
            </span>{" "}
            and{" "}
            <span className="text-[#e2c898] font-amatic font-bold lg:text-[2.7rem] md:text-4xl text-xl lg:leading-10">
            ...
            <span className="text-[#e2c898] font-amatic font-bold lg:text-[2.7rem] md:text-4xl text-xl lg:leading-10 underline decoration-double decoration-1 underline-offset-2">
