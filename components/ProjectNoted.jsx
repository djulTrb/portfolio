...
const ProjectNoted = ({ scrollYProgress }) => {
  ...
  return (
    ...
    >
      ...
      <section className="md:col-start-5 col-span-full row-span-full xxxs:max-md:row-start-5 xxxs:max-md:row-span-full md:row-start-1 md:row-span-full  bg-[#fff5ee] lg:px-14 md:px-4 xxs:max-md:px-4 xxxs:max-xxs:pl-3 xxxs:max-xxs:pr-1 md:pt-20 xxs:pt-7 xxxs:pt-4">
        <div className="flex items-center justify-between w-full">
          <h1 className="text-6xl xxxs:max-xs:text-5xl font-amatic relative">
            2. Noted:{" "}
          </h1>{" "}
          <a
            href="https://app-noted.netlify.app/"
            target="_blank"
            className="px-4 py-1.5 font-urbanist font-semibold bg-rose-200 text-rose-800 rounded-full flex items-center gap-0.5"
          >
