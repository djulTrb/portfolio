...
const ProjectRestaurant = ({ scrollYProgress }) => {
  ...
  return (
    ...
    >
      <section className="md:col-span-5 xxxs:max-md:row-start-5 xxxs:max-md:row-span-full bg-[#fff5ee] lg:px-14 md:px-4 xxs:max-md:px-4 xxxs:max-xxs:pl-3 xxxs:max-xxs:pr-1 md:pt-20 xxs:pt-7 xxxs:pt-4">
